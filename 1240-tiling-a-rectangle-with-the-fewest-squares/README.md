<h2><a href="https://leetcode.com/problems/tiling-a-rectangle-with-the-fewest-squares/?envType=problem-list-v2&envId=55ac4kuc">1240. Tiling a Rectangle with the Fewest Squares</a></h2><h3>Hard</h3><hr><p>Given a rectangle of size <code>n</code> x <code>m</code>, return <em>the minimum number of integer-sided squares that tile the rectangle</em>.</p>
